...
In the HY-TCM-main.tex file you will find the following STEPS 0--4. Below you can find related instructions.
\vspace{0.5cm}
...
{\textbf{STEP 1 -- Set up your personal information}}
...
{\textbf{STEP 2 -- Writing your thesis}}
...
{\textbf{STEP 3 -- Set your bibliography style}}

\begin{itemize}
\item The default style is numbered [1], but it can be easily changed to Author-Year (Einstein, 1905) or alphabetical [Ein05], as the examples of these are in comments.
\item Discuss the style to use with your supervisor.
\end{itemize}

{\textbf{STEP 4 -- Write your abstract}}
